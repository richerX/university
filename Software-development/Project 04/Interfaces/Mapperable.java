package ru.hse.homework4.Interfaces;
...
public interface Mapperable {
     ...
     */
    <T> T readFromString(Class<T> clazz, String input) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException, NoSuchFieldException, ClassNotFoundException, NotSupportedException;
    /**
     ...
     */
    <T> T read(Class<T> clazz, InputStream inputStream) throws IOException, IllegalAccessException, NoSuchMethodException, InvocationTargetException, InstantiationException, NoSuchFieldException, ClassNotFoundException, NotSupportedException;
    /**
     ...
     * @throws IOException в случае ошибки ввода-вывода
     */
    <T> T read(Class<T> clazz, File file) throws IOException, IllegalAccessException, NoSuchMethodException, InvocationTargetException, InstantiationException, NoSuchFieldException, ClassNotFoundException, NotSupportedException;
    /**
     ...
     */
    String writeToString(Object object) throws NotSupportedException, IllegalAccessException;
    /**
     ...
     * @throws IOException в случае ошибки ввода-вывода
     */
    void write(Object object, OutputStream outputStream) throws IOException, NotSupportedException, IllegalAccessException;
    /**
     ...
     * @throws IOException в случае ошибки ввода-вывода
     */
    void write(Object object, File file) throws IOException, NotSupportedException, IllegalAccessException;
}
